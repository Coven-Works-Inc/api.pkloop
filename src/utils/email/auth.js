...
const sendMail = async (email, firstname, token) => {
  const emailData = {
    ...
    html: `
            Hello ${firstname}!, Welcome to PKLoop, the most efficient platform for parcel delivery. Click on the link to get started <a href="http://mypkloop.com/verify?token=${token}" style="text-decoration: none;">Verify Me</a>
        `
  }
