  ...
  switch (template) {
    case 'welcome':
      data = {
        ...
        html: `Welcome to PKLoop, the most efficient platform for parcel delivery. Click on the link to get started <a href="http://pkloop.herokuapp.com/verify?token=${token}" style="text-decoration: none;">Verify Me</a>`
      }
      break
    case 'reset':
      data = {
