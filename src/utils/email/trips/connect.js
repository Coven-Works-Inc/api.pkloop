...
const sendMail = async (
  ...
  const emailData = {
    ...
    html: tip ?  `
        ...
        <br />
        <br />
        <a href="http://mypkloop.com/dashboard/transactions" style="color: white; background:blue; width: 100px;  outline: none; border: 1px solid blue; padding: 10px; text-decoration: none;">Accept</a>
        <a href="http://mypkloop.com/dashboard/transactions" style="color: red; background: white; width: 100px; outline: none; padding: 10px; border: 1px solid red; text-decoration: none;">Reject</a>
        <br />
        `
        : 
        `
